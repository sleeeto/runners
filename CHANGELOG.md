...
[Full diff](https://github.com/sider/runners/compare/0.55.0...HEAD)

Misc:

- **ESLint** Allow ESLint8.x in user dependency [#2820](https://github.com/sider/runners/pull/2820)

## 0.55.0

[Full diff](https://github.com/sider/runners/compare/0.54.0...0.55.0)
...
- **PMD CPD** 6.38.0 -> 6.39.0 [#2708](https://github.com/sider/runners/pull/2708)
- **PMD Java** 6.38.0 -> 6.39.0 [#2709](https://github.com/sider/runners/pull/2709)
...
- **RuboCop** 1.20.0 -> 1.21.0 [#2684](https://github.com/sider/runners/pull/2684)
...
- Fix Runners version manually 0.53.0 -> 0.53.4 [#2664](https://github.com/sider/runners/pull/2664)

## 0.53.4

[Full diff](https://github.com/sider/runners/compare/0.53.3...0.53.4)
...
- **PMD CPD** 6.37.0 -> 6.38.0 [#2647](https://github.com/sider/runners/pull/2647)
